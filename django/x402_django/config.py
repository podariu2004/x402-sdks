"""Config resolution — mirrors the other SDKs (same env vars)."""
...
# Kept identical to the other SDK defaults so every SDK points at the same
# place (env X402_BASE_URL overrides; trailing "/" stripped).
